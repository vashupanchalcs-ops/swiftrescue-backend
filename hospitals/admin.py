...
class HospitalAdmin(admin.ModelAdmin):
    ...
    # Capacity is maintained by the hospital portal and bed workflow. Admin
    # can inspect it, but must not overwrite the live bed counts manually.
    list_editable = ("status", "is_active")
    readonly_fields = (
        "total_beds", "available_beds", "emergency_beds", "icu_beds",
        "available_icu_beds", "oxygen_beds", "ventilators_total",
        "ventilators_available", "ambulance_bays", "last_capacity_updated",
